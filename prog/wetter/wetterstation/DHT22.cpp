 ...
 */
DHT22::DHT22(int8_t offset, uint8_t DDRpin, volatile uint8_t *DHT22DDR, volatile uint8_t *DHT22PORT, uint8_t DHT22INT, uint8_t DHT22ISC0, uint8_t DHT22ISC1, uint8_t DHT22INTF, volatile uint8_t *DHT22EIMSK, volatile uint8_t *DHT22EICRA, volatile uint8_t *DHT22EIFR, uint8_t DHT22CS1, volatile uint8_t *TIMEROCRREGISTER, volatile uint8_t *TIMERCOUNTERREGISTER, volatile uint8_t *DHT22TCCRB)
{
	DHT22_OFFSET = offset;

	DHT22_PIN	= DDRpin;
	DHT22_DDR	= DHT22DDR;
	DHT22_PORT	= DHT22PORT;

	DHT22_INT	= DHT22INT;
	DHT22_ISC0  = DHT22ISC0; 
	DHT22_ISC1	= DHT22ISC1;
	DHT22_INTF	= DHT22INTF;
	DHT22_EIMSK	= DHT22EIMSK;	
	DHT22_EICRA	= DHT22EICRA;	
	DHT22_EIFR	= DHT22EIFR;

	DHT22_CS1				= DHT22CS1;
	TIMER_OCR_REGISTER		= TIMEROCRREGISTER;
	TIMER_COUNTER_REGISTER	= TIMERCOUNTERREGISTER;
	DHT22_TCCRB				= DHT22TCCRB;
...
uint8_t DHT22::DHT22_CheckStatus(){
	...
	if (state == DHT_CHECK_CRC){
		...
		if( checkSum == ( (csPart1 + csPart2 + csPart3 + csPart4) & 0xFF ) ){ // Checksum correct
			...
			humidity_integral = (uint8_t)(rawHumidity / 10.0)+DHT22_OFFSET;
